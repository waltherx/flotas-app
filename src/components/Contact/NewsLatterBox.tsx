const NewsLatterBox = () => {
  return (
    ...
    >
      ...
      Trans Copacabana S.A. pone a su disposición un Centro de Atención a través del cual usted puede realizar consultas, hacer un reclamo o brindarnos sugerencias para mejorar el servicio. Por favor ingrese los datos en los campos del formulario y a la brevedad nos pondremos en contacto.
      </p>
      {/*<form>
        <input
          type="text"
